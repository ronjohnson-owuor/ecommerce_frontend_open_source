  ...
  return (
	<div className='text-color font-NotoSansNabataean min-h-screen'>
		<div className='w-full grid grid-cols-1 sm:grid-cols-2 items-center mb-10 sm:mb-2'>
			...
			<h1 className='font-extrabold mt-10 sm:mt-2 overflow-hidden text-3xl sm:text-2xl md:text-3xl xl:text-5xl text-primary mb-2'>Your Premier Destination for Crocheting Creations and Décor</h1>
			...
			<img src={yarn} className='hidden sm:block' alt="yarn logo" />
		</div>
			<div className='w-full mt-10 mb-20 flex items-center justify-center flex-col'>
				<h1 className='text-4xl font-bold text-primary overflow-hidden'>our vision</h1>
			...
			<div>
				<h1 className='text-primary text-md font-bold mb-4'>Core values</h1>
			...
			{/* our offering */}
			<div>
				<h1 className='text-primary text-md font-bold mb-4'>Our offering</h1>
				<ul className='w-[95%] sm:w-[80%] text-sm'>
